...
{
    public static unsafe BOOL RedrawWindow(HWND hWnd, RECT* lprcUpdate, HRGN hrgnUpdate, REDRAW_WINDOW_FLAGS flags)
        => PlatformApi.Window.RedrawWindow(hWnd, lprcUpdate is not null ? *lprcUpdate : null, hrgnUpdate, flags);
